...
{
    public float shakeSpeed = 0.5f; // how fast the camera shaking
    public float shakeAmount = 1f; // the amplitude of shaking
    ...
    private void Update()
    {
        ...
        float offsetY = Mathf.PerlinNoise(0, timer * shakeSpeed) * 2 - 1;
